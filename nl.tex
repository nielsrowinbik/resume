...
\cvsubsection{ProRail}[\enquote{Student} (parttime)][Utrecht][2016-2018]
\begin{itemize}
...
\cvsubsection{Studentaanhuis.nl}[\enquote{Student} (parttime)][Amersfoort en
      Utrecht][2013-2016]
\begin{itemize}
...
\cvsubsection{'t Atrium}[(T)VWO (tweetalig voorbereidend wetenschappelijk
